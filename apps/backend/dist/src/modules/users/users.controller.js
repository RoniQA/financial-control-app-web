...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Atribuir role ao usuário' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Role atribuída com sucesso' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Remover role do usuário' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Role removida com sucesso' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Param)('roleId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
