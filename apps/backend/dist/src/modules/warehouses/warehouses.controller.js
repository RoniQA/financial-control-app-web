...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Obter warehouse padrão da empresa' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Warehouse padrão encontrado' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], WarehousesController.prototype, "getDefaultWarehouse", null);
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listar warehouses da empresa' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista de warehouses' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
