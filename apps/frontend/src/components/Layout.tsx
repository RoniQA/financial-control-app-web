  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-secondary-50 via-white to-primary-50 dark:from-dark-bg dark:via-dark-surface dark:to-dark-bg">
      ...
      <div className={`fixed inset-0 z-50 lg:hidden transition-opacity duration-300 ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        />
        <div className="fixed inset-y-0 left-0 flex w-72 flex-col bg-white/95 dark:bg-dark-surface/95 backdrop-blur-xl shadow-2xl animate-slide-in">
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-72 lg:flex-col">
        <div className="flex flex-col flex-grow bg-white/80 dark:bg-dark-surface/80 backdrop-blur-xl border-r border-white/20 dark:border-dark-border shadow-large">
          <div className="flex h-20 items-center px-6 bg-gradient-primary">
            <div className="flex items-center space-x-3">
          ...
          <div className="p-4 border-t border-white/20 dark:border-dark-border">
            <div className="flex items-center space-x-3 p-3 bg-secondary-50 dark:bg-dark-surface2 rounded-xl">
      ...
      <div className="lg:pl-72">
        {/* Top bar */}
        <div className="sticky top-0 z-40 flex h-20 shrink-0 items-center gap-x-4 border-b border-white/20 dark:border-dark-border bg-white/80 dark:bg-dark-surface/80 backdrop-blur-xl px-4 shadow-soft sm:gap-x-6 sm:px-6 lg:px-8">
          <button
            type="button"
            className="-m-2.5 p-2.5 text-secondary-700 dark:text-dark-textSecondary lg:hidden hover:text-primary-600 transition-colors"
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            ...
            <div className="flex items-center gap-x-4 lg:gap-x-6">
              <div className="hidden lg:flex lg:items-center lg:space-x-4">
                <div className="text-sm text-secondary-700 dark:text-dark-textSecondary">
                  Olá, <span className="font-medium text-secondary-900 dark:text-dark-text">{user?.firstName}</span>
                </div>
                <div className="w-8 h-8 bg-primary-100 dark:bg-primary-900 rounded-lg flex items-center justify-center">
                  <User className="h-4 w-4 text-primary-600 dark:text-primary-400" />
                </div>
              ...
              <button
                onClick={logout}
                className="p-2 text-secondary-400 dark:text-dark-textSecondary hover:text-danger-600 hover:bg-danger-50 dark:hover:bg-danger-900/20 rounded-lg transition-all duration-200"
                title="Sair"
              >
